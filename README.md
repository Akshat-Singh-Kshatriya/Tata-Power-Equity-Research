...
| Deleveraging Trajectory | Valuation Sensitivity (Football Field) |
| :---: | :---: |
| ![Deleveraging Chart](output/deleveraging_chart.png) | ![Sensitivity Heatmap](output/sensitivity_heatmap.png) |
